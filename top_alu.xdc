...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {lower_bits}]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {reset}]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {higher_bits}]
...
##Buttons
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports p5]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports p4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports p1]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports p3]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports p2]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets p5_IBUF]
